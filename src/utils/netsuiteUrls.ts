...
const RECORD_URL_MAP: Record<string, string> = {
	...
	itemship: "/app/accounting/transactions/itemfulfillment.nl",
	itemfld: "/app/accounting/transactions/itemfulfillment.nl",
	itemreceipt: "/app/accounting/transactions/itemreceipt.nl",
	itemrcpt: "/app/accounting/transactions/itemreceipt.nl",
